...
export default function NewProductScreen() {
  ...
  const handleSubmit = async () => {
    ...
    const variantData: Omit<ApiProductVariant, 'stock'>[] = validVariants.map((v) => ({
      ...
      label: v.label.trim() || `${v.size || v.color || v.sku}`.trim(),
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.offlineState}>
          ...
          <Text style={styles.offlineSubtext}>Creating products requires an internet connection.</Text>
        </View>
      </SafeAreaView>
    );
  }
          ...
          {variants.map((variant, idx) => (
            <View key={variant.key} style={styles.variantCard}>
              ...
              <TextInput
                ...
                placeholder="Price adjustment (e.g. 2.00 or -1.50)"
                keyboardType="decimal-pad"
