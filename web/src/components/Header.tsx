...
// Main navigation is Home / Discography / Concerts only (D-24). About and
// Contact live in the footer. Desktop shows the full nav inline; mobile uses a
// hamburger toggle (D-27). Toggle button is a 44x44 tap target (UI-SPEC).
